Pod::Spec.new do |s|
  ...
  s.source_files = 'MQX 3.8/whistle/corona/{include,common/wmps}/wmps1.{c,h}', 'WhistleProto/*.{m,h}' 
  ...
  s.pre_install do |pod, target_definition|
    protoc_objc_plugin = File.join(s.config.project_pods_root, "protobuf-objc-iOS5", "src", "compiler", "protoc-gen-objc")
    proto_src_dir = File.join(s.config.project_pods_root, "corona_fw", "MQX 3.8", "whistle", "corona", "common", "wmp")
    proto_target_dir = File.join(s.config.project_pods_root, "corona_fw", "WhistleProto")	
